...
function numeroMasGrande(numeros) {
  ...
  for (var i = 1; i < numeros.length; i++) {
    if (numeros[i] > sum) {sum = numeros[i]};
  }
  return sum;
...
function empiezaConNueve(n) {
  ...
  var array = Array.from(String (n), func);
...
//analizar bien este ejercicio. la respuesta esta sacada de internet con conceptos que todavia no aprendi.
